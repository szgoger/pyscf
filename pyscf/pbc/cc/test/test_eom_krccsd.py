...
# Running HF and CCSD with 1x1x2 Monkhorst-Pack k-point mesh
        ...
        self.assertAlmostEqual(lib.fp(hc), (-2.6150413036393965-0.19907650078902575j), 9)
        hc = eom.matvec(vector, 1, imds)
        self.assertAlmostEqual(lib.fp(hc), (-1.9105694521337282+0.4623839551783548j ), 9)
        hc = eom.matvec(vector, 2, imds)
        self.assertAlmostEqual(lib.fp(hc), (-3.5191623401512224-0.09803987909800496j), 9)
...
# Running HF and CCSD with 1x1x2 Monkhorst-Pack k-point mesh
        ...
        self.assertAlmostEqual(lib.fp(hc), (-0.949011705031009-1.7265645132373515j), 9)
        hc = eom.l_matvec(vector, 1, imds)
        self.assertAlmostEqual(lib.fp(hc), (-0.4497554820276424-5.620765551481647j), 9)
        hc = eom.l_matvec(vector, 2, imds)
        self.assertAlmostEqual(lib.fp(hc), (-1.905718559569895+2.7776121499610347j), 9)
